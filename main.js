...
function createWindow () {
  ...
  // mainWindow.loadURL('https://vault.trollar.life', options);
  ...
  const template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: 'View GitHub',
          click () { loadExternal('https://github.com/cronoh/trollarvault') }
        },
        {
          label: 'Submit Issue',
          click () { loadExternal('https://github.com/cronoh/trollarvault/issues/new') }
        },
        {type: 'separator'},
        {
          type: 'normal',
          label: `TrollarVault Version: ${autoUpdater.currentVersion}`,
        },
        {
          label: 'View Latest Updates',
          click () { loadExternal('https://github.com/cronoh/trollarvault/releases') }
        },
        {type: 'separator'},
        {
